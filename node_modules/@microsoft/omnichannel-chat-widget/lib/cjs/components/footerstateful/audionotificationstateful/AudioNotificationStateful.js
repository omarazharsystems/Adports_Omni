...
const AudioNotificationStateful = props => {
  ...
  const audioRef = (0, _react.useRef)(new Audio(audioSrc));
  (0, _react.useEffect)(() => {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any
    _omnichannelChatComponents.BroadcastService.getMessageByEventName("NewMessageNotification").subscribe(msg => {
