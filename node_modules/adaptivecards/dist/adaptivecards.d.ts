...
declare module 'adaptivecards/host-config' {
	...
	export class InputConfig {
	    ...
	    allowRevealOnHoverStyle: boolean;
	    constructor(obj?: any);
	}
...
declare module 'adaptivecards/card-elements' {
	...
	export class ChoiceSetInput extends Input {
	    ...
	    renderChoices(fetchedChoices: FetchedChoice[]): void;
	...
	export class FilteredChoiceSet {
	    ...
	    processStaticChoices(): void;
	    processResponse(fetchedChoices: FetchedChoice[]): void;
	    showLoadingIndicator(): void;
	    removeLoadingIndicator(): void;
	    showErrorIndicator(error: string): void;
