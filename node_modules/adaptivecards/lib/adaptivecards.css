...
.ac-input.ac-textInput.ac-choiceSetInput-filtered-dropdown, .ac-input.ac-numberInput.ac-choiceSetInput-filtered-dropdown, .ac-input.ac-dateInput.ac-choiceSetInput-filtered-dropdown, .ac-input.ac-timeInput.ac-choiceSetInput-filtered-dropdown, .ac-input.ac-multichoiceInput.ac-choiceSetInput-filtered-dropdown {
  background-color: white;
  border-top: 0px;
  display: none;
  max-height: 200px;
...
.ac-input.ac-choiceSetInput-choice.focused {
